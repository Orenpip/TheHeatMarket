...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  if [[ -n $ZSH_VERSION ]]; then
    ARGV0=rg /Users/yahelraviv/.local/share/claude/versions/2.1.81 "$@"
  elif [[ "$OSTYPE" == "msys" ]] || [[ "$OSTYPE" == "cygwin" ]] || [[ "$OSTYPE" == "win32" ]]; then
    ARGV0=rg /Users/yahelraviv/.local/share/claude/versions/2.1.81 "$@"
  elif [[ $BASHPID != $$ ]]; then
    exec -a rg /Users/yahelraviv/.local/share/claude/versions/2.1.81 "$@"
  else
    (exec -a rg /Users/yahelraviv/.local/share/claude/versions/2.1.81 "$@")
  fi
}
fi
export PATH=/Users/yahelraviv/.antigravity/antigravity/bin\:/Users/yahelraviv/Library/Java/JavaVirtualMachines/openjdk-25.0.1/Contents/Home/bin\:/Users/yahelraviv/.local/bin\:/Users/yahelraviv/.nvm/versions/node/v24.11.1/bin\:/Library/Frameworks/Python.framework/Versions/3.13/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/opt/homebrew/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Applications/Docker.app/Contents/Resources/bin
