...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/yahelraviv/.claude/downloads/claude-2.1.7-darwin-arm64 --ripgrep'
fi
export PATH=/Users/yahelraviv/.nvm/versions/node/v24.11.1/bin\:/Library/Frameworks/Python.framework/Versions/3.13/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/opt/homebrew/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Applications/Docker.app/Contents/Resources/bin\:/Applications/Docker.app/Contents/Resources/bin
